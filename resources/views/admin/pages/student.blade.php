    ...
    <main class="content">
        <div class="container-fluid p-0">
            ...
            <h1 class="h3 mb-3">Student
                <a href="#" class="float-end btn btn-sm btn-success" data-bs-toggle="modal" data-bs-target="#add_brand">Add Student</a>
            </h1>
            <!-- Modal for add  -->
            <div class="modal fade" id="add_brand" tabindex="-1" aria-labelledby="add_brand_Label" aria-hidden="true">
