...
@section('content')
    <main class="content">
        <div class="container-fluid p-0">
            <h1 class="h3 mb-3 ">Add new routine</h1>
            <div class="row">
                <div class="col">
                    <form method="post" action="{{route('admin.class.store')}}" >
                        ...
                        <fieldset class="border border-secondary p-2 mt-2">
                            <legend class="float-none w-auto p-2">Routine</legend>
                            <div id="batch">
                                ...
                                <div class="row mt-3" id="batch_1">
                                    <div class="col-md-6">
                                        <div class="form-inline">
                                            <div class="form-group ">
                                                ...
                                                <select class="custom-select mx-sm-3" id="batch_name_1" name="sub_name[]" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-inline">
                                            <div class="form-group ">
                                                <label for="batch_name_1">Teacher Initial</label>
                                                <input type="text" class="form-control mx-sm-1" id="batch_name_1" name="batch_name[]" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-inline">
                                            <div class="form-group ">
                                                ...
                                                <input type="time" class="form-control mx-sm-2" id="class_start_1" name="class_start[]" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-10">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="checkbox" name="subDay[]" id="subDay" value="option1">
                                            <label class="form-check-label" for="subDay">Sat</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="checkbox" name="subDay[]" id="subDay" value="option2">
                                            <label class="form-check-label" for="subDay">Sun</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="checkbox" name="subDay[]" id="subDay" value="option1">
                                            <label class="form-check-label" for="subDay">Mon</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="checkbox" name="subDay[]" id="subDay" value="option2">
                                            <label class="form-check-label" for="subDay">Tue</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="checkbox" name="subDay[]" id="subDay" value="option1">
                                            <label class="form-check-label" for="subDay">Wed</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="checkbox" name="subDay[]" id="subDay" value="option2">
                                            <label class="form-check-label" for="subDay">Thu</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
