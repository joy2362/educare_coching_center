                            ...
                            <div class="m-sm-4">
                                ...
                                <form method="POST" action="{{ route('admin.login') }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control form-control-lg @error('email') is-invalid @enderror " id="email" type="email" name="email" placeholder="Enter your email" required value="{{ old('email') }}" autocomplete="email" autofocus />
                                        @error('email')
